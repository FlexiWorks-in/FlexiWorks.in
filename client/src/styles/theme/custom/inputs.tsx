        ...
        variants: [
          ...
          },
          {
            ...
            style: {
              ...
              backgroundImage: `linear-gradient(to bottom, ${green[600]}, ${green[800]})`,
              boxShadow: `inset 0 1px 0 ${green[600]}, inset 0 -1px 0 1px hsl(220, 0%, 0%)`,
        ...
        variants: [
          ...
          },
          {
            ...
            style: {
              ...
              backgroundImage: `linear-gradient(to bottom, ${green[500]}, ${green[900]})`,
              boxShadow: `inset 0 1px 0 ${green[600]}, inset 0 -1px 0 1px hsl(220, 0%, 0%)`,
              border: `1px solid ${green[700]}`,
              "&:hover": {
                backgroundImage: "none",
